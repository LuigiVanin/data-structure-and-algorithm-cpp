...
TEST_CASE("Test SelectionSort algorithm", "[SelectionSort]") {
    ...
    SECTION("Sort with custom function pointer (ascending)") {
        ...
        sorting::SelectionSort(list, compareAscending);
    ...
    SECTION("Sort with custom function pointer (descending)") {
        ...
        sorting::SelectionSort(list, compareDescending);
    ...
    SECTION("Sort with lambda function (ascending)") {
        ...
        sorting::SelectionSort(list, [](int a, int b) -> int {
            if (a < b) return -1;
            if (a > b) return 1;
            return 0;
        });
    ...
    SECTION("Sort empty list") {
        ...
        REQUIRE_NOTHROW(sorting::SelectionSort(list));
        REQUIRE(list->Length() == 0);
